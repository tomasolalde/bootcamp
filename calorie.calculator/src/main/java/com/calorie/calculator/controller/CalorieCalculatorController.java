...
public class CalorieCalculatorController {
    ...
    public ResponseEntity<PlateTotalCaloriesDTO> calculateTotalCalories(@RequestBody PlateOfFoodDTO plate) {
    ...
    public ResponseEntity<ArrayList<PlateTotalCaloriesDTO>> calculateTotalCaloriesPlates(@RequestBody ArrayList<PlateOfFoodDTO> plates) {
