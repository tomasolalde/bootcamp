...
public class CalorieCalculatorController {
    ...
    public ResponseEntity<ArrayList<FoodDTO>> getListOfFood() throws FileNotFoundException, ApiException {
        return new ResponseEntity<>(service.getFood(), HttpStatus.OK);
    }

    @GetMapping(value = "/calculate-calories")
    public ResponseEntity<PlateTotalCaloriesResponseDTO> calculateTotalCalories(@RequestBody PlateOfFoodDTO plate) throws FileNotFoundException, ApiException {
    ...
    public ResponseEntity<ArrayList<PlateTotalCaloriesResponseDTO>> calculateTotalCaloriesPlates(@RequestBody ArrayList<PlateOfFoodDTO> plates) throws FileNotFoundException, ApiException {
